...
const WORK_EXPERIENCE = [
  {
    ...
    items: [
      ...
      'Improved users\' financial goal tracking by building data extraction, structuring, and analysis of flows that calculate weekly progress, identified improvement areas, and generated recommended actions.',
  ...
  },
  {
    ...
    items: [
      ...
      'Automated support and analysis of workflows for field technicians and back-office administrators by enabling database retrieval, document retrieval, contextualized answers, failure-cause analysis, and custom report generation.',
  ...
  },
  {
    ...
    items: [
      ...
      'Led multidisciplinary teams across programs, products, and technology to define needs, prioritize deliverables, coordinate implementation, and ensure quality assurance across digital services and operational workflows.',
      'Established technical documentation, operating procedures, and delivery standards to improve team communication and support effective product development across programs, product, and technology workflows.'
    ]
  },
  {
    id: 'work-4',
    ...
    items: [
      ...
      'Improved field asset tracking and operational control by building a geolocation system with OpenStreetMap and Mapbox that allows teams to locate assets, review their field status, and support decision-making.',
